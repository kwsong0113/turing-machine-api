...
LAW_DICT: dict[int, (LawType, ...)] = {
    ...
    6: (LawType.SINGLE_COMPARE, 1, 1, "=="),
    8: (LawType.SINGLE_COMPARE, 1, 3, "=="),
    9: (LawType.SINGLE_COMPARE, 1, 4, "=="),
    10: (LawType.SINGLE_COMPARE, 1, 5, "=="),
    11: (LawType.SINGLE_COMPARE, 2, 1, "=="),
    13: (LawType.SINGLE_COMPARE, 2, 3, "=="),
    14: (LawType.SINGLE_COMPARE, 2, 4, "=="),
    15: (LawType.SINGLE_COMPARE, 2, 5, "=="),
